...
const sampleAgents: Agent[] = [
  ...
  },
  {
    ...
    bio: "Robert specializes in ultra-luxury properties and has a network of high-net-worth clients looking for exceptional homes. With 15 years of experience in the luxury market, Robert has developed an eye for quality and craftsmanship that sets him apart in the industry. His attention to detail ensures clients find properties that meet their exacting standards.",
  ...
  },
  {
    ...
    bio: "Priya helps clients with international property transactions and relocation services across multiple countries. Her multilingual skills and knowledge of global markets make her the perfect agent for international buyers and sellers. She specializes in creating seamless experiences for clients moving between countries.",
  ...
  },
  {
    ...
    bio: "David works with developers and investors on new construction and property development projects. His background in architecture and urban planning provides a unique perspective on property development opportunities. He has overseen numerous successful residential and commercial projects from concept to completion.",
  ...
  },
  {
    ...
    bio: "Jennifer specializes in helping families find their perfect homes. Her client-centered approach and deep understanding of family needs make her an excellent advocate for homebuyers. With 9 years in residential real estate, she has developed strong negotiation skills and market knowledge.",
  ...
  },
  {
    ...
    bio: "Marcus specializes in urban properties, from trendy lofts to historic brownstones. His in-depth knowledge of city neighborhoods helps clients find the perfect location that matches their lifestyle. Marcus is particularly skilled at identifying emerging areas with growth potential for investment properties.",
